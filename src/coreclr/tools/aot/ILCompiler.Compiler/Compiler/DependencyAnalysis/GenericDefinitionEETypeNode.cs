...
namespace ILCompiler.DependencyAnalysis
{
    internal abstract class GenericDefinitionEETypeNode : EETypeNode
    {
        ...
        {
            return factory.ReflectionInvisibleGenericDefinitionTypeSymbol(_type);
        }
    ...
    internal sealed class ReflectionInvisibleGenericDefinitionEETypeNode : GenericDefinitionEETypeNode
    {
        ...
        {
            return factory.ReflectionVisibleGenericDefinitionTypeSymbol(_type).Marked;
        }
    ...
    internal sealed class ReflectionVisibleGenericDefinitionEETypeNode : GenericDefinitionEETypeNode
    {
        ...
        protected override DependencyList ComputeNonRelocationBasedDependencies(NodeFactory factory)
        {
            ...
            dependencyList.Add(factory.ReflectionInvisibleGenericDefinitionTypeSymbol(_type), "Reflection invisible type for a visible type");
